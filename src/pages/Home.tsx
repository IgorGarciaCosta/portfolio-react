...
export default function Home() {
  return (
    /*  grid              ⇒ fácil centralizar
        min-h[...]        ⇒ ocupa a viewport inteira menos o header fixo
        gap-6             ⇒ distância vertical entre elementos
    */
    <section className="grid min-h-[calc(100vh-6rem)] place-items-center gap-6 text-center">
      {/* wrapper interno só para agrupar e controlar width */}
